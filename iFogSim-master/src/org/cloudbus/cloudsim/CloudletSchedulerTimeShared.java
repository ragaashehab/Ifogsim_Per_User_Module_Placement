...
////////////////////////////////////ragaa/////////////////////////////////////////////
	protected Double mips;  //ragaa
	protected int numberOfPes;  //ragaa
	public CloudletSchedulerTimeShared(double mips, int numberOfPes) {  //ragaa
		// TODO Auto-generated constructor stub
		super();		
		cloudletExecList = new ArrayList<ResCloudlet>();
		cloudletPausedList = new ArrayList<ResCloudlet>();
		cloudletFinishedList = new ArrayList<ResCloudlet>();
		currentCPUs = numberOfPes; //ragaa
		mips= mips; //ragaa
		numberOfPes=numberOfPes;//ragaa	
		setCurrentRequestedMips(mips,numberOfPes); //ragaa 
	}
///////////////////////////////////ragaa////////////////////////////////////////////*/
	...
	public double updateVmProcessing(double currentTime, List<Double> mipsShare) {
		...
		//System.out.println();
		//System.out.println("cloudletschedulertimeshared updateVmProcessing " + mipsShare );//+ " capacity of mipsshare"+getCapacity(mipsShare));
		...
		for (ResCloudlet rcl : getCloudletExecList()) {			
			...
			//System.out.println("cloudletschedulertimeshared vmid "+rcl.getCloudlet().getVmId()+ " cloudletid "+rcl.getCloudlet().getCloudletId()+" cloudletlength "+rcl.getCloudlet().getCloudletLength() + " remaining cloudletlength "+rcl.getRemainingCloudletLength());//+ rcl.getTotalCurrentAllocatedMipsForCloudlet(rcl, timeSpam)
	...
	//}
////////////ragaaa code /////////////////////////////////////////
	private List<Double> mipsShare = new ArrayList<Double>();
	public void setCurrentRequestedMips(double mips, int numberOfPes) {		
		for(int i=0; i< numberOfPes ; i++)
			mipsShare.add(mips);   //ragaa
		//System.out.println("cloudletschedulertimeshared mips "+ mips+ " setCurrentRequestedMips mipsshare "+mipsShare);		
	}
	
	 // ragaa getCurrentRequestedMips 
	   // replaced by assigning new cloudlet length at fogdevice checkcloudletcompletion for each resultant tuple
	@Override
	public List<Double> getCurrentRequestedMips() {
		List<Double> mipsShare = new ArrayList<Double>();		
		//List<Double> mymipsShare = Arrays.asList(1000.00);  return mymipsShare;  // try		
		//System.out.println("cloudletschedulertimeshared getCurrentRequestedMips  mipsshare  " +mipsShare);
		return mipsShare;		
	}
