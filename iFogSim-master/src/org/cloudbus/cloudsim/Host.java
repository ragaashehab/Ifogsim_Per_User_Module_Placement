...
public class Host {
	...
	public void addMigratingInVm(Vm vm) {
		...
		System.out.println("host addMigratingInVm 0000000000000000000000000000000000000000000");
		System.out.println();
		System.out.println("host id " +this.getId()+ " module " + vm.getId());
		...
		if (!getVmsMigratingIn().contains(vm)) {
			...
			System.out.println("host  " + this.getId()+ " VmList "+  getVmList());
	...
	public boolean vmCreate(Vm vm) {
		if (getStorage() < vm.getSize()) {
			//Log.printLine
			System.out.println(this.getDatacenter().getName()+ " [VmScheduler.vmCreate] Allocation of VM #" + vm.getId()+ ((AppModule)vm).getName() +" to Host #" + getId()
					+ " failed by storage");
			return false;
		}
		...
		if (!getBwProvisioner().allocateBwForVm(vm, vm.getCurrentRequestedBw())) {
			System.out.println("[VmScheduler.vmCreate] Allocation of VM #" + vm.getId() + " to Host #" + getId()
					+ " failed by BW"+ vm.getCurrentRequestedBw());
