...
/*///////////////ragaa add priority to vm/////////////////////////
	...
	public Vm(int id, int userId, double mips, int numberOfPes, int ram, long bw, long size, String vmm,
			CloudletScheduler cloudletScheduler, int Prty) {
...
/////////////ragaa  end add prty to modules////////////////////*/
	...
	public List<Double> getCurrentRequestedMips() {
		...
		//System.out.println(this.getId()+ "isBeingInstantiated "+isBeingInstantiated()+ currentRequestedMips);
	 ...
	 */
	 public void setMips(double mips) {  //protected ragaa changed 
		this.mips = mips;
	}
	...
	public void setBeingInstantiated(boolean beingInstantiated) {
		//System.out.println("vm "+this.getId()+ beingInstantiated); //ragaa
