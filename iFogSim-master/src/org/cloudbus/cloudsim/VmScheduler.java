...
public abstract class VmScheduler {
	...
	public VmScheduler(List<? extends Pe> pelist) {
		setPeList(pelist);
		setPeMap(new HashMap<String, List<Pe>>());    //ragaa for spaceshared scheduling
		setMipsMap(new HashMap<String, List<Double>>());  //ragaa for timeshared scheduling
...
/*///////////////ragaa////////////////////////////
	public void setTotalAllocatedMipsForVm(AppModule module, List<Double> TotalAllocatedMipsForVm) {
		// TODO Auto-generated method stub
		
		module.setCurrentAllocatedMips(TotalAllocatedMipsForVm);
