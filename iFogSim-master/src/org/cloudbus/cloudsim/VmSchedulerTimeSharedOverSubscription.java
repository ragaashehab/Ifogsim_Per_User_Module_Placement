...
public class VmSchedulerTimeSharedOverSubscription extends VmSchedulerTimeShared {
	...
	protected boolean allocatePesForVm(String vmUid, List<Double> mipsShareRequested) {
		...
		//System.out.println("me nooooooooooo allocatePesForVm vmscheduleroversubscription "+vmUid+" mipsShareRequested "+ " " +mipsShareRequested + " getPeCapacity "+ getPeCapacity());
		...
		//System.out.println("allocatePesForVm vmscheduleroversubscription totalRequestedMips  " + totalRequestedMips);
		...
		//System.out.println("AvailableMips " + getAvailableMips()+ " totalRequestedMips " +totalRequestedMips);		
	...
	protected void redistributeMipsDueToOverSubscription() {
		...
		//System.out.println("ragaanew oversubscription MipsMapRequested "+getMipsMapRequested()+" totalRequiredMipsByAllVms "+totalRequiredMipsByAllVms+" totalAvailableMips "+totalAvailableMips+"scalingFactor"+scalingFactor);
