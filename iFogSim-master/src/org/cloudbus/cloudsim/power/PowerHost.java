...
public class PowerHost extends HostDynamicWorkload {
	...
	public PowerHost(
		...
		/////////ragaa
		//System.out.println("powerhostid "+ id+" vmScheduler " + vmScheduler +" vmscheduleravailablemips "+ vmScheduler.getAvailableMips());
		/////////ragaa
	}
	...
	public double getEnergyLinearInterpolation(double fromUtilization, double toUtilization, double time) {
		...
		//System.out.println("powerhost fromPower " +fromPower + " toPower " +toPower );
