...
public class VmSchedulerTimeSharedOverbookingEnergy extends VmSchedulerTimeSharedOverSubscription implements PowerUtilizationInterface{
	...
	/*
	///////////////////////////////////////ragaanew add scheduling priority to users////////////////////////////////////////
	/**
	...
	protected boolean allocatePesForVm(String vmUid, List<Double> mipsShareRequested) {
		...
		//System.out.println("rayan ya fegl "+vmUid+" mipsShareRequested "+ " " +mipsShareRequested + "PeCapacity "+ getPeCapacity());
		...
		//System.out.println("overbooking "+vmUid+" mipsShareRequested " +mipsShareRequested +" MipsMapRequested "+getMipsMapRequested()+ "MipsMap" +getMipsMap());
		//System.out.println( "AvailableMips " + getAvailableMips()+ " totalRequestedMips " +totalRequestedMips+" totalRequestedMipscapped  " + mipsShareRequestedCapped);		

		if (getAvailableMips() >= totalRequestedMips) {
			//System.out.println("AvailableMips " + getAvailableMips()+ " totalRequestedMips " +totalRequestedMips+" AvailableMips >= totalRequestedMips ");
			//System.out.println("AvailableMips >= totalRequestedMips ");
			...
			//System.out.println("AvailableMips >= totalRequestedMips  new allocation "+vmUid+" MipsMap "+ getMipsMap());

			
		} else {
			//System.out.println("========================================================");
			//System.out.println("AvailableMips " + getAvailableMips()+ " totalRequestedMips " +totalRequestedMips+" MipsMapRequested"+getMipsMapRequested()+" AvailableMips < = totalRequestedMips then redistributeMipsDueToOverSubscription ");
			//System.out.println("AvailableMips < = totalRequestedMips then redistributeMipsDueToOverSubscription ");
...
/*	protected void redistributeMipsDueToOverSubscription() {
		...
		//System.out.println("overbooking  MipsMapRequested "+getMipsMapRequested()+" totalRequiredMipsByAllVms "+totalRequiredMipsByAllVms+" totalAvailableMips "+totalAvailableMips+"scalingFactor"+scalingFactor);
		...
		setAvailableMips(0);
		//System.out.println("new allocation after scaling  MipsMap "+ getMipsMap());

	}
/////////////////////////////////////end ragaanew schduling users//////////////////////////////////////////////////////
	*/
}
