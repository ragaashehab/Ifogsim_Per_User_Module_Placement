...
public class AppEdge {
	...
	public AppEdge(String source, String destination, double tupleCpuLength, 
			double tupleNwLength, String tupleType, int direction, int edgeType, double UsrPrty){
		setSource(source);
	...
	private double UsrPrty;           //////ragaa user priority
	public void setUsrPrty(double UsrPrty){
		this.UsrPrty = UsrPrty;
	}
	public double getUsrPrty() {
		return UsrPrty;
	}
