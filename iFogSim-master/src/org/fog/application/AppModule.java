...
public class AppModule extends PowerVm{
	...
	private int Prty; // the module priority ragaa
	...
	public AppModule(
			...
			long size,
			String vmm,
			CloudletScheduler cloudletScheduler, // new TupleScheduler(mips,1)==>TupleScheduler(double mips, int numberOfPes) ragaa
			Map<Pair<String, String>, SelectivityModel> selectivityMap, int modprty) {
		//super(id, userId, mips, pesNumber, ram, bw, size, priority, vmm, cloudletScheduler, 300); // 300 scheduling interval
		super(id, userId, mips, 1, ram, bw, size, modprty, vmm, cloudletScheduler, 300); // 300 scheduling interval
		setName(name);
		setId(id);
		setAppId(appId);
		setUserId(userId);
		...
		setPrty(modprty);
		//setCurrentRequestedMips(new ArrayList<Double>());  //ragaa
	}
	
///////////////ragaa add prty to modules/////////////////////
		public void setPrty(int Prty) {
...
/*///////////ragaa///////////////////////////////////////////
	private List<Double> CurrentRequestedMips;
	public void setCurrentRequestedMips(List<Double> CurrentRequestedMips) {
		// TODO Auto-generated method stub
		this.CurrentRequestedMips= CurrentRequestedMips;		
	}
	public List<Double> getCurrentRequestedMips() {
		CurrentRequestedMips.clear();
		CurrentRequestedMips.add(getMips());
		//CurrentRequestedMips.add(getMips()*0.25);
