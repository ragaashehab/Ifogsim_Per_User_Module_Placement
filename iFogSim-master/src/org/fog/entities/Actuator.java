...
//////////////ragaa//////////////////////////////////////////////////////////////////////////////////
	...
	private void processTupleArrival(SimEvent ev) {
		...
		Integer mobileid = this.getGatewayDeviceId();   //ragaa
		...
		for(AppLoop loop : app.getLoops()){
			if(loop.hasEdge(srcModule, destModule) && loop.isEndModule(destModule)){
				...
				//System.out.println("ActTupid "+ tuple.getActualTupleId()+" cloudltid "+ tuple.getCloudletId()+ " cloudletfinishedsofar "+tuple.getCloudletFinishedSoFar()+ " actuatorid "+ tuple.getActuatorId()+ " desmodule "+ tuple.getDestModuleName()+ " sourcemodu "+tuple.getSrcModuleName()+ tuple.getTupleType());
				
				double currentAverageUser = TimeKeeper.getInstance().getCurrentAverageUser().get(mobileid);
				int currentCountUser = TimeKeeper.getInstance().getCurrentNumUser().get(mobileid);
				...
				TimeKeeper.getInstance().getCurrentAverageUser().put(mobileid, newAverageUser);
				TimeKeeper.getInstance().getCurrentNumUser().put(mobileid, currentCountUser+1);
