...
public class Sensor extends SimEntity{
	...
	public void transmit(){
		...
		double TPrty = _edge.getUsrPrty();  //////ragaa user priority to tuples
		Tuple tuple = new Tuple(getAppId(), FogUtils.generateTupleId(), Tuple.UP, cpuLength, 1, nwLength, outputSize, 
				new UtilizationModelFull(), new UtilizationModelFull(), new UtilizationModelFull(), this.gatewayDeviceId);
		...
		/////////////ragaa
		tuple.setTPrty(this.gatewayDeviceId);
		//System.out.println("----------------------------------------------------------------------------------------");
		//System.out.println("sensor gatewayid "+ this.getGatewayDeviceId()+ " actualtupid "+ tuple.getActualTupleId()+ "tuple priority"+ tuple.getTPrty() +" cloudletid " + tuple.getCloudletId() + " Srcmod "+ tuple.getSrcModuleName() +" Destmod "+ tuple.getDestModuleName()+ " actuatorid "+ tuple.getActuatorId()+ " cloudletlength "+tuple.getCloudletLength()+ " tupletype "+ tuple.getTupleType()+" tupleprty mobileid " +tuple.getTPrty());
