...
public class FogLinearPowerModel implements PowerModel {
	...
	public double getPower(double utilization) throws IllegalArgumentException {
		//System.out.println("foglinearpowermodle utilization" +utilization);
		if (utilization < 0 || utilization > 1) {             //ragaa commented the error
...
///////////////////////ragaa  update to public /////////
	...
	public double getStaticPower() {   ////////////ragaa  update to public /////////
		return staticPower;
	}
